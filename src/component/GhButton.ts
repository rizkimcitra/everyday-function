...
const GhButton = () => {
  ...
  const ghButton = createElement(
    'a',
    'inline-flex items-center justify-center space-x-2 md:space-x-2.5 py-2 px-4 md:py-2.5 md:px-6 rounded bg-gray-800 text-white'
  )

  ghButton.innerHTML = `${svg}
  <span>GitHub</span>`
  ghButton.setAttribute('href', 'https://github.com/rizkimcitra/everyday-function')
  ghButton.setAttribute('target', '_blank')
  ghButton.setAttribute('rel', 'noopener noreferrer')
  return ghButton
}
